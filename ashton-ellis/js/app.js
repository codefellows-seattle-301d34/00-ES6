...
function displayPics(){
  ...
  // RESPONSE: When the keyword 'let' is used to declare this variable, the scope of the variable is limited to the code block in which it is declared (the while loop). Therefore, you cannot access it outside of that code block, and the console.log breaks.
  console.log(viewed);
