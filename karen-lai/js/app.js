...
function displayPics(){
  ...
  // This is because the declaration 'rando' is now within the scope of the while block. If the console.log is within that same block, it would not throw an error.
  console.log(viewed)
