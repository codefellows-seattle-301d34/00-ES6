...
function displayPics(){
  ...
  console.log("This should be an error" + rando);
  // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `var to let.
  // PUT YOUR RESPONSE IN THIS COMMENT -- It throws an error because of the scope of let.  let cannot use the variable rando with makeRandom as makeRandom is a separate function defined outside the codeblock.  
  console.log(viewed)
