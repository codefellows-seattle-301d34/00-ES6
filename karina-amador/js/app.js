...
function displayPics(){
  ...
  // rando is not running because it is declared as a let inside of displayPics function, and that is also why the console.log wasn't finding it.Console.log should have been inside the function for it to work. A let is a block-scoped local variable.
  console.log(viewed);
