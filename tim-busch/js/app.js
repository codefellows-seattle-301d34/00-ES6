...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: The variable threw an error because it has scoped the variable rando into the function. Let keeps rando within the displayPics code block.
  console.log(viewed);
