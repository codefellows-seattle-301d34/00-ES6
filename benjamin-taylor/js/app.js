...
function displayPics(){
  ...
  // When switching var to let in the function displayPics, rando became scoped to that function, and therefore cannot be referenced outside of that function.
  console.log(viewed);
